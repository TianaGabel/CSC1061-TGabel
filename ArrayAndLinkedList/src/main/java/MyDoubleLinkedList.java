...
public class MyDoubleLinkedList<E> implements List<E> {
	...
	public int count() {
		return size; //this will "count" the nodes int the list
	}
	
	public void reverse() {//this will reverse the list order
		//Add each node to a new list,
		//then set our head equal to the begining of the new list
	}
